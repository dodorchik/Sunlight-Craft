...
package sunlight.craft.gui;

import sunlight.craft.item.ItemEvilightnugget;
import sunlight.craft.ScMod;
...
public class GuiSolarGUI extends ElementsScMod.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiSolarGUI(ElementsScMod instance) {
		super(instance, 27);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 26, 34) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(ItemEvilightnugget.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 134, 34) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				ScMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("sc:textures/solar_gui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Interfase in development", 7, 69, -6710887);
		}
		...
		protected void actionPerformed(GuiButton button) {
			ScMod.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
